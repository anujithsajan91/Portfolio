    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-4">
          ...
          <ParticleCard
            className="card card--border-glow row-span-3 flex flex-col gap-4 p-6 rounded-[20px]"
            style={{
          ...
          >
            <div>
              ...
              <p className="text-sm opacity-80 mt-2">
                Have a role, collaboration, or idea in mind? Drop a message and I’ll get back to you.
              </p>
            </div>
          ...
          <ParticleCard
            className="card card--border-glow p-5 rounded-[20px] h-full"
            style={{
              backgroundColor: 'var(--background-dark)',
              borderColor: 'var(--border-color)',
              color: 'white'
            ...
            glowColor={glowColor}
          >
            <h4 className="text-sm tracking-widest opacity-70 mb-3">SOCIAL</h4>
            <div className="flex gap-4 text-sm">
              <a href="https://github.com/anujithsajan91" className="hover:text-purple-400 transition">
              <FontAwesomeIcon icon={faGithub} className='text-2xl'/> <br />
                GitHub
              </a>
              <a href="#" className="hover:text-purple-400 transition">
                <FontAwesomeIcon icon={faLinkedin} className='text-2xl' /> <br />
                Linked In</a>
            </div>
          </ParticleCard>
          ...
          <ParticleCard
            ...
            glowColor={glowColor}
          >
            <h4 className="text-sm tracking-widest opacity-70 mb-3">CONTACT INFO</h4>
            <p className="text-sm">
              <FontAwesomeIcon icon={faAt} />
               anujithsajan005@gmail.com</p>
          ...
          <ParticleCard
            ...
            glowColor={glowColor}
          >
            <h4 className="text-sm tracking-widest opacity-70 mb-3">I CAN HELP WITH</h4>
            <ul className='font-medium text-sm'>
              <li>React / Frontend Development</li>
              <li>Coldfusion / Backend Development</li>
            </ul>
          </ParticleCard>
